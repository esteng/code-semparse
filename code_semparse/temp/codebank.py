...
def filter_people_by_education_start(people, start_year):

    return [person for person in people if has_education_before_2004(person)]

def filter_people_by_friend_employment_end(people, end_year):

    return [person for person in people if has_friend_with_employment_end_before(person)]
